...
class DNIUtils {
    ...
    calculaLetraDNI(dni){
        ...
        let tablaDigitoControl = ['T','R','W','A','G','M','Y','F','P','D','X','B','N','J','Z','S','Q','V','H','L','C','K','E'];
        ...
        let tablaSustitucionNIE = {'X':0, 'Y':1, 'Z':2};
        ...
        if(matchDNIValido !== null && matchDNIValido.length === 2){
            ...
            return tablaDigitoControl[indiceControl];
        }
        ...
        if(matchNIEValido !== null && matchNIEValido !== 3) {
            ...
            let numNIEConverted = tablaSustitucionNIE[letraNIE] + numeroNIE;
